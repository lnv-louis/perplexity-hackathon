...
import type { Citation, LayoutItem, WidgetContentData } from '@/types/widgets';
              ...
              components={{
                ...
                a: ({node: _node, href, ...props}) => {
                  ...
                  if (isCitation) {
                    ...
                    const citation = apiWidget.citations?.find((c: Citation) => c.number === parseInt(citationNum || '0'));
                    return (
                      <a 
                ...
                h1: ({node: _node, ...props}) => <h1 className="font-bold text-xl mb-3 mt-4 text-gray-900" {...props} />,
                h2: ({node: _node, ...props}) => <h2 className="font-bold text-lg mb-2 mt-3 text-gray-900" {...props} />,
                h3: ({node: _node, ...props}) => <h3 className="font-semibold text-base mb-2 mt-3 text-gray-800" {...props} />,
                code: ({node: _node, ...props}) => <code className="bg-gray-100 px-1 py-0.5 rounded text-sm" {...props} />,
              }}
            >
              {apiWidget.content}
            </ReactMarkdown>
