  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-6">
      ...
      <Link href="/" className="fixed top-6 left-6 z-50">
        <button className="flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-lg hover:bg-white transition-colors">
      ...
      <Card className="w-full max-w-md p-8 shadow-xl relative z-10 bg-white">
